        ...
        <table className="w-full border border-zinc-600 border-collapse text-sm">
          <thead>
            <tr className="bg-zinc-800 text-white">
              <th className="border border-zinc-700 py-2 px-3 text-center">Product</th>
              <th className="border border-zinc-700 py-2 px-3 text-center">Receipt</th>
              <th className="border border-zinc-700 py-2 px-3 text-center" colSpan="2">
                Cases
              </th> 
              <th className="border border-zinc-700 py-2 px-3 text-center" colSpan="2">
                Bottles
            ...
            <tr className="bg-zinc-800 text-white">
              ...
              <th className="border border-zinc-700 py-2 px-3">-</th>
              <th className="border border-zinc-700 py-2 px-3 text-center">Warm</th>
              <th className="border border-zinc-700 py-2 px-3 text-center">Cold</th>
              <th className="border border-zinc-700 py-2 px-3 text-center">Warm</th>
              <th className="border border-zinc-700 py-2 px-3 text-center">Cold</th>
            </tr>
          </thead>
          ...
          <tbody>
            {rows.map((r, i) => (
              <tr key={i} className="text-center">
                {/* Product */}
                <td className="border py-2 px-3 align-middle border border-zinc-700">{r.product}</td>
                ...
                {[
                  ...
                  <td key={field} className="border py-2 px-3 border border-zinc-700">
                    <input
                      type="number"
                      value={r[field]}
